...
public class Config {
    public static File backgroundMusic = new File("client/src/main/resources/music.mp3");
    public static File buttonClickSound = new File("client/src/main/resources/button2.mp3");
    ...
    public static double timeForIntermediate = 10000; //milliseconds, time the intermediate leaderboard shows
    public static double timeAnswerReveal = 10000; //milliseconds, time the revealed answers show\
