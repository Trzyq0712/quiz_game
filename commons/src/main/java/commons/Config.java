...
public class Config {
    ...
    public static long timePerQuestion = 1000; //milliseconds
    public static long timeForIntermediate = 1000; //milliseconds, time the intermediate leaderboard shows
    public static long timeAnswerReveal = 1000; //milliseconds, time the revealed answers show\
