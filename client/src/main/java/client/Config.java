...
public class Config {
    ...
    public static double timeForIntermediate = 20000; //milliseconds, time the intermediate leaderboard shows
    public static double timeAnswerReveal = 20000; //milliseconds, time the revealed answers show\
