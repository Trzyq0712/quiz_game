...
public class Config {
    ...
    public static long timePerQuestion = 15000; //milliseconds
    public static long timeForIntermediate = 3000; //milliseconds, time the intermediate leaderboard shows
    public static long timeAnswerReveal = 3000; //milliseconds, time the revealed answers show\
